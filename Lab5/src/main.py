...
def check_imports(source_name):
    ...
    with open('/home/xwl7110/EECS348_Labs/Labs/Lab5/src/student_code.py',"r") as f:
        tokens = f.read().replace("\n", " ").split()
...
def main():
    ...
    predict = bayes.classify('/home/xwl7110/EECS348_Labs/Labs/Lab5/src/classifyA.txt')
    fA = f_score('/home/xwl7110/EECS348_Labs/Labs/Lab5/src/answersA.txt',predict)
